...
public class MessageDialog extends nc.ui.pub.beans.UIDialog implements
  ...
  private nc.ui.pub.beans.UIComboBox ivjUIComboBox_Input2 = null;
  ...
  public static int[] m_btnkeys = new int[] {
    ID_OK, ID_NO, ID_CANCEL, ID_YESTOALL, ID_NOTOALL
  };
  ...
  class IvjEventHandler implements java.awt.event.ActionListener {
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
      ...
      if (e.getSource() == MessageDialog.this.getUIButton1())
        connEtoC1(e);
      if (e.getSource() == MessageDialog.this.getUIButton2())
        connEtoC2(e);
      if (e.getSource() == MessageDialog.this.getUIButton3())
        connEtoC3(e);
      if (e.getSource() == MessageDialog.this.getUIButton4())
        connEtoC4(e);
      if (e.getSource() == MessageDialog.this.getUIButton5())
        connEtoC5(e);
    };
  };
   ...
   * @deprecated
   */
  public MessageDialog(java.awt.Container parent) {
    super(parent);
    initialize();
  }
   ...
   * @deprecated
   */
  public MessageDialog(java.awt.Container parent, String title) {
    super(parent, title);
    initialize();
  }
  ...
  private void btn1_ActionPerformed() {
    ...
    if (getUITextField_Input().isVisible())
      ...
      objs[0] = getUIComboBox_Input().getSelectedItem();
      objs[1] = getUIComboBox_Input2().getSelectedItem();
      setInputValue(objs);
    }
    else
      setInputValue(null);
  ...
  private UICheckBox getchkShow() {
    if (ivjchkShow == null) {
      try {
        ...
        ivjchkShow.setText(nc.ui.ml.NCLangRes.getInstance().getStrByID(
            "_Beans", "UPP_Beans-000089")/* @res "连续显示" */);
   ...
   */
  public static MessageDialog getSingleton() {
   ...
   * @return MessageDialog
   */
  public static MessageDialog getSingleton(Container parent) {
  ...
  private UIComboBox getUIComboBox_Input() {
    ...
    if (ivjUIComboBox_Input == null) {
      try {
        ...
        ivjUIComboBox_Input.setPreferredSize(new java.awt.Dimension(120, 22));
        ivjUIComboBox_Input.setBounds(29, 172, 120, 22);
  ...
  private UIComboBox getUIComboBox_Input2() {

    if (ivjUIComboBox_Input2 == null) {
      try {
        ivjUIComboBox_Input2 = new nc.ui.pub.beans.UIComboBox();
        ivjUIComboBox_Input2.setName("UIComboBox_Input2");
        ivjUIComboBox_Input2.setPreferredSize(new java.awt.Dimension(120, 22));
        ivjUIComboBox_Input2.setBounds(29, 172, 120, 22);
        ivjUIComboBox_Input2.setVisible(false);
        // user code begin {1}
        ivjUIComboBox_Input2.setMaximumRowCount(2);
        // user code end
      }
      catch (java.lang.Throwable ivjExc) {
        // user code begin {2}
  ...
  private javax.swing.JPanel getUIDialogContentPane() {
    if (ivjUIDialogContentPane == null) {
      try {
        ...
        ivjUIDialogContentPane.setBackground(UIManager
  ...
  private UIButtonLayout getUIPanel_ButtonsUIButtonLayout() {
    ...
    try {
      /* 创建部件 */
      ivjUIPanel_ButtonsUIButtonLayout =
          new nc.ui.pub.beans.UIButtonLayout(true, 0, -1, 10, -1, -1);
  ...
  private UIPanel getUIPanel_Message() {
    if (ivjUIPanel_Message == null) {
      try {
        ...
        ivjUIPanel_Message.setPreferredSize(new java.awt.Dimension(bound_width
            + bound_x + 5, bound_height + bound_y + 5));
  ...
  private UIScrollPane getUIScrollPane_Message() {
    if (ivjUIScrollPane_Message == null) {
      try {
        ...
        ivjUIScrollPane_Message.setPreferredSize(new java.awt.Dimension(
            bound_width, 10));
        ...
        ivjUIScrollPane_Message.setBounds(bound_x, bound_y, bound_width,
            bound_height);
  ...
  public void keyPressed(java.awt.event.KeyEvent e) {
    ...
    if (keyCode == java.awt.event.KeyEvent.VK_INSERT
        && getUITextField_Input().getText() != null) {
      btn1_ActionPerformed();
      getUITextField_Input().requestFocus();
      return;
    }
    if (modifiers < 2
        && (getUITextField_Input().hasFocus()
            || getUIComboBox_Input().hasFocus() || getUIComboBox_Input2()
            .hasFocus()) || keyCode == 16 || keyCode == 17 || keyCode == 18)
      return;
    ...
    if (modifiers < 2) {
      if (e.getKeyCode() == KeyEvent.VK_ENTER) {
        ...
        if (m_nType == OK_CANCEL_OPTION || m_nType == YES_NO_CANCEL_OPTION
            || m_nType == YES_YESTOALL_NO_CANCEL_OPTION
            || m_nType == YES_YESTOALL_NO_NOTOALL_CANCEL_OPTION)
          index = 2;
      }
      else {
        index =
            getShortKey().indexOf(String.valueOf(e.getKeyChar()).toUpperCase());
        if (index < 0) // 处理上下左右键
        {
  ...
  public static void showUnknownErrorDlg(Container parent, Exception e) {
    ...
    String message =
        NCLangRes.getInstance().getStrByID("_beans", "UPP_Beans-000104")/*未知错误*/;
  ...
  public static int showErrorDlg(Container parent, String title, String error) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("beansv5",
              "UPPbeansv5-000013")/*@res "错误信息"*/;

    }
    dispatchMesasge(parent, MessageHistoryEvent.ERROR, error);
    return showMessageBox(parent, MessageDialog.OK_OPTION,
        MessageDialog.ERROR_ICON, title, error, ID_CLOSE);
  }

  public static int showHintDlg(Container parent, String title, String hint) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
              "UPP_Beans-000053")/* @res "提示" */;
    }
    dispatchMesasge(parent, MessageHistoryEvent.HINT, hint);
    return showMessageBox(parent, MessageDialog.OK_OPTION,
        MessageDialog.HINT_ICON, title, hint, ID_OK);
  }
  ...
  public static int showHintsDlg(Container parent, String title, String hint) {
    ...
    dispatchMesasge(parent, MessageHistoryEvent.HINT, hint);
    return showMessageBox(parent, MessageDialog.OK_OPTION,
        MessageDialog.WARNING_ICON, title, hint, ID_OK);
  }

  private static Object showInputBox(Container parent, int type, int icon,
      String title, String message, Object firstValue, int maxLength, int dec,
      String dataType) {
    // 显示消息
    ...
    MessageDialog dlg = getSingleton(parent);
    if (dlg.isVisible()) { // 如果公共实例正在使用就新生成一个
      dlg = new MessageDialog(parent);
    }
    ...
    pnl.setPreferredSize(new Dimension(200, 22));
    ...
    if (dataType != null && dataType.trim().length() != 0
        && !dataType.equalsIgnoreCase(TEXT_STR)) {
    ...
    try {
      dlg.getUILabelIcon().setIcon(
          new javax.swing.ImageIcon(dlg.getClass().getResource(key)));
  ...
  /* 增加连续显示 */
  private static Object showInputBox(Container parent, int type, int icon,
      String title, String message, Object firstValue, int maxLength,
      boolean isCheckShow) {
    // 显示消息
    // String messageDisplay = StringUtil.recoverWrapLineChar(message);
    // 2014-12-11 对于传入这样的串"d:\\festival"，显示会有问题，修改为不要转义处理
    ...
    java.util.StringTokenizer token =
        new java.util.StringTokenizer(messageDisplay, "\n");
    int iRows = 0;
  ...
  public static Object showInputDlg(Container parent, int type, String title,
      String message, Object firstValue, int maxLength) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
              "UPP_Beans-000090")/* @res "警告" */;
    }
    return showInputBox(parent, type, MessageDialog.WARNING_ICON, title,
        message, firstValue, maxLength, false);
  }

  public static Object showInputDlg(Container parent, int type, String title,
      String message, Object firstValue, int maxLength, int dec, String dataType) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
              "UPP_Beans-000090")/* @res "警告" */;
    ...
    return showInputBox(parent, type, MessageDialog.WARNING_ICON, title,
        message, firstValue, maxLength, dec, dataType);
  }

  public static Object showInputDlg(Container parent, String title,
      String message, Object firstValue) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
              "UPP_Beans-000090")/* @res "警告" */;
    }
    return showInputBox(parent, MessageDialog.OK_CANCEL_OPTION,
        MessageDialog.WARNING_ICON, title, message, firstValue,
        MessageDialog.TEXTMAXLENGTH, false);
  }
  ...
  public static Object showInputDlg(Container parent, String title,
    ...
    return showInputBox(parent, MessageDialog.OK_CANCEL_OPTION,
        MessageDialog.WARNING_ICON, title, message, firstValue, maxLength,
        false);
  }
  ...
  public static Object showInputDlg(Container parent, String title,
    ...
    return showInputBox(parent, MessageDialog.OK_CANCEL_OPTION,
        MessageDialog.WARNING_ICON, title, message, firstValue, maxLength, dec,
        dataType);
  }

  /* 增加是否连续显示界面 */
  public static Object showInputDlg(Container parent, String title,
      String message, Object firstValue, int maxLength, boolean isChkShow) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
              "UPP_Beans-000090")/* @res "警告" */;
  ...
  private static int showMessageBox(Container parent, int type, int icon,
      String title, String message, int button) {
    // String messageDisplay = StringUtil.recoverWrapLineChar(message);
    // 2014-12-11 对于传入这样的串"d:\\festival"，显示会有问题，修改为不要转义处理
    String messageDisplay = message;
    if (messageDisplay == null)
    ...
    dlg.setSize(size_width, size_height);
    dlg.getUIScrollPane_Message().setBounds(bound_x, bound_y, bound_width,
        bound_height);
    ...
    dlg.getUIScrollPane_Message().setBounds(bound_x, bound_y, bound_width,
        bound_height);
    dlg.getUIScrollPane_Message().setPreferredSize(
        new java.awt.Dimension(bound_width, bound_height));
    ...
    switch (icon) {
      case WARNING_ICON:
        dlg.getUILabelIcon().setIcon(Style.getImage("消息.警告"));/*-=notranslate=-*/

        break;
      case QUESTION_ICON:
        dlg.getUILabelIcon().setIcon(Style.getImage("消息.问题"));/*-=notranslate=-*/

        break;
      case ERROR_ICON:
        dlg.getUILabelIcon().setIcon(Style.getImage("消息.错误"));/*-=notranslate=-*/

        break;
      case HINT_ICON:
        dlg.getUILabelIcon().setIcon(Style.getImage("消息.显示"));/*-=notranslate=-*/
        break;
      default:
        dlg.getUILabelIcon().setIcon(Style.getImage("消息.提示"));/*-=notranslate=-*/
    ...
    if (messageDisplay.length() >= dlg.getUITextMessage().getMaxLength())
      messageDisplay =
          messageDisplay
              .substring(0, dlg.getUITextMessage().getMaxLength() - 5) + "...";
  ...
  public static int showOkCancelDlg(Container parent, String title,
      String question) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
              "UPP_Beans-000093")/* @res "询问" */;
    }
    return showMessageBox(parent, MessageDialog.OK_CANCEL_OPTION,
        MessageDialog.QUESTION_ICON, title, question, ID_OK);
  }

  public static int showOkCancelDlg(Container parent, String title,
      String question, int button) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
              "UPP_Beans-000093")/* @res "询问" */;
    ...
    return showMessageBox(parent, MessageDialog.OK_CANCEL_OPTION,
        MessageDialog.QUESTION_ICON, title, question, button);
  }

  private static Object showSelectBox(Container parent, int type, int icon,
      String title, String message, Object[] allValue, int maximumRowCount) {
    // 显示消息
    String messageDisplay = message;
    // if (message != null && !message.trim().equals(""))
    // messageDisplay =
    ...
    if (fm == null)
      fm = dlg.getFontMetrics(new Font("Dialog", Font.PLAIN, 20));
    if (messageDisplay != null
        && fm.stringWidth(messageDisplay) >= SIZE_CHOOSER_LENGTH) {
      size_width = SIZE_WIDTH_MIDDLE;
      size_height = SIZE_HEIGHT_MIDDLE;
      bound_width = BOUND_WIDTH_MIDDLE;
      bound_height = BOUND_HEIGHT_MIDDLE;
    ...
    dlg.getUIScrollPane_Message().setPreferredSize(
        new java.awt.Dimension(bound_width, bound_height - reduce));
    //
    dlg.getUIComboBox_Input().setBounds(bound_x,
        bound_y + bound_height - reduce + 7, bound_width - 10, 22);
    dlg.getUIPanel_Message().add(dlg.getUIComboBox_Input(),
    ...
    if (iRows >= 3) {
      int height = 17;
      int first = 10;
      dlg.getUITextMessage().setBounds(0, 0, bound_width - 36,
          iRows * height + first);
      dlg.getUITextMessage().setPreferredSize(
          new Dimension(bound_width - 36, iRows * height + first));
    }
  ...
  private static Object showSelectBox2(Container parent, int type, int icon,
      String title, String message, Object[] allValue1, Object[] allValue2,
      int maximumRowCount) {
    // 显示消息
    String messageDisplay = message;
    // if (message != null && !message.trim().equals(""))
    ...
    dlg.getUIPanel_Message().remove(dlg.getUITextField_Input());
    if (allValue1 != null && allValue1.length > 0) {
      for (int i = 0; i < allValue1.length; i++) {
        dlg.getUIComboBox_Input().addItem(allValue1[i]);
      }
    }
    if (allValue2 != null && allValue2.length > 0) {
      for (int i = 0; i < allValue2.length; i++) {
        dlg.getUIComboBox_Input2().addItem(allValue2[i]);
      }
    }
    if (maximumRowCount > 0) {
      dlg.getUIComboBox_Input().setMaximumRowCount(maximumRowCount);
      dlg.getUIComboBox_Input2().setMaximumRowCount(maximumRowCount);
    }
    //
    int reduce = 30;
    dlg.getUIScrollPane_Message().setBounds(bound_x, bound_y, bound_width,
    ...
    //
    dlg.getUIComboBox_Input().setBounds(bound_x,
        bound_y + bound_height - reduce + 7, 120, 22);
    dlg.getUIComboBox_Input2().setBounds(bound_x,
        bound_y + bound_height - reduce + 7, 120, 22);
    UIPanel southPanel = new UIPanel();
    southPanel.setPreferredSize(new java.awt.Dimension(bound_width + bound_x
        + 5, 22 + 5));
    southPanel.setLayout(new BorderLayout());
    southPanel.add(dlg.getUIComboBox_Input(), java.awt.BorderLayout.WEST);
    southPanel.add(dlg.getUIComboBox_Input2(), java.awt.BorderLayout.EAST);
    dlg.getUIPanel_Message().add(southPanel, java.awt.BorderLayout.SOUTH);
    dlg.getUIComboBox_Input().setVisible(true);
    dlg.getUIComboBox_Input2().setVisible(true);
  ...
  public static Object showSelectDlg(Container parent, int type, String title,
      String message, Object[] allValue, int maximumRowCount) {
    if (title == null) {
      title = nc.ui.ml.NCLangRes.getInstance().getStrByID("common", "null")/* @res "选择" */;
    }
    return showSelectBox(parent, type, MessageDialog.WARNING_ICON, title,
        message, allValue, maximumRowCount);
  }

  public static Object showSelectDlg2(Container parent, int type, String title,
      String message, Object[] allValue1, Object[] allValue2,
      int maximumRowCount) {
    if (title == null) {
      title = nc.ui.ml.NCLangRes.getInstance().getStrByID("common", "null")/* @res "选择" */;
    }
    return showSelectBox2(parent, type, MessageDialog.WARNING_ICON, title,
        message, allValue1, allValue2, maximumRowCount);
  }

  public static Object showSelectDlg(Container parent, String title,
      String message, Object[] allValue, int maximumRowCount) {
    if (title == null) {
      title = nc.ui.ml.NCLangRes.getInstance().getStrByID("common", "null")/* @res "选择" */;
    }
    return showSelectBox(parent, MessageDialog.OK_CANCEL_OPTION,
        MessageDialog.WARNING_ICON, title, message, allValue, maximumRowCount);
  }

  public static int showWarningDlg(Container parent, String title,
      String warning) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
    ...
    return showMessageBox(parent, MessageDialog.OK_OPTION,
        MessageDialog.WARNING_ICON, title, warning, ID_OK);
  }

  public static int showYesNoCancelDlg(Container parent, String title,
      String question) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
    ...
    return showMessageBox(parent, MessageDialog.YES_NO_CANCEL_OPTION,
        MessageDialog.QUESTION_ICON, title, question, ID_YES);
  }
  ...
  public static int showYesNoDlg(Container parent, String title, String question) {
    ...
    return showMessageBox(parent, MessageDialog.YES_NO_OPTION,
        MessageDialog.QUESTION_ICON, title, question, ID_YES);
  }

  public static int showYesNoDlg(Container parent, String title,
      String question, int button) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
  ...
  public static int showYesToAllNoCancelDlg(Container parent, String title,
      String question) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
    ...
    return showMessageBox(parent, MessageDialog.YES_YESTOALL_NO_CANCEL_OPTION,
        MessageDialog.QUESTION_ICON, title, question, ID_YES);
  }
  ...
  public static int showYesToAllNoToAllCancelDlg(Container parent,
    ...
    return showMessageBox(parent,
        MessageDialog.YES_YESTOALL_NO_NOTOALL_CANCEL_OPTION,
        MessageDialog.QUESTION_ICON, title, question, ID_YES);
  }

  public static int showYesToAllNoToAllCancelDlg(Container parent,
      String title, String question, int button) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
              "UPP_Beans-000093")/* @res "询问" */;
  ...
  public static int showYesToAllNoToAllDlg(Container parent, String title,
      String question) {
    if (title == null) {
      title =
          nc.ui.ml.NCLangRes.getInstance().getStrByID("_Beans",
    ...
    return showMessageBox(parent, MessageDialog.YES_YESTOALL_NO_NOTOALL_OPTION,
        MessageDialog.QUESTION_ICON, title, question, ID_YES);
  }
  ...
  private static void dispatchMesasge(Container aContainer, int aType,
      String aMsg) {
    Component c = aContainer;

    while (c != null) {
      if (c instanceof IMessageHistory) {
        ((IMessageHistory) c).dispatchMessage(new MessageHistoryEvent(
            aContainer, aType, aMsg));
        return;
      }
      else {
        c = c.getParent();
