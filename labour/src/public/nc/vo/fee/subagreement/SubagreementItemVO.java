...
public class SubagreementItemVO extends SuperVO {
	
/**
*主键
*/
public java.lang.String pk_subagreement_b;
/**
*集团
*/
...
/**
* 属性 pk_subagreement_b的Getter方法.属性名：主键
*  创建日期:2017-12-6
* @return java.lang.String
*/
public java.lang.String getPk_subagreement_b() {
return this.pk_subagreement_b;
} 

/**
* 属性pk_subagreement_b的Setter方法.属性名：主键
* 创建日期:2017-12-6
* @param newPk_subagreement_b java.lang.String
*/
public void setPk_subagreement_b ( java.lang.String pk_subagreement_b) {
this.pk_subagreement_b=pk_subagreement_b;
} 
...
/**
* 属性pleader的Setter方法.属性名：班组长
* 创建日期:2017-12-6
* @param newPleader nc.vo.fee.workteam.WorkteamVO
*/
...
* @return String
*/
public String getPk_subagreement(){
return this.pk_subagreement;
}
/**
* 属性生成上层主键的Setter方法.属性名：上层主键
* 创建日期:2017-12-6
* @param newPk_subagreement String
*/
public void setPk_subagreement(String pk_subagreement){
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("fee.subagreementItem");
    }
   }
